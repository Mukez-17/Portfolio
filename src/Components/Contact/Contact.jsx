...
function Contact() {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_tncdw73', 'template_juhb4gr', formRef.current, 'GAcQmMqDhhhi40AUq',)
            .then(() => {
                setSuccess(true);
            },
            (error) => {
    ...
    <motion.div className='contact' ref={ref} variants={variants} initial="initial" whileInView="animate">
        <motion.div className="textContainer" variants={variants}>
            ...
            <motion.div className="item" variants={variants}>
                <h2>Mail</h2>
                <span>mukeshdevtr17@gmail.com</span>
            </motion.div>
            <motion.div className="item" variants={variants}>
                <h2>Address</h2>
            ...
            <motion.div className="item" variants={variants}>
                <h2>Phone</h2>
                <span>+91 86102 34843</span>
            </motion.div>
        </motion.div>
        <div className="formContainer">
            <motion.div className="phoneSvg" initial={{opacity:1}} whileInView={{opacity:0}} transition={{delay:3, duration:1}}>
            <svg width="450px" height="450px" viewBox="0 0 32.666 32.666">
                <motion.path stroke-width="0.2" fill="none" initial={{pathLength:0}} animate={isInView && {pathLength:1}} transition={{duration:3}}
                ...
                C32.666,7.326,25.339,0,16.333,0z" pathLength="1" stroke-dashoffset="0px" stroke-dasharray="1px 1px">
                </motion.path>
            </svg>
            </motion.div>
